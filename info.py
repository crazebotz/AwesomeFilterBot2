...
ADMINS = environ.get("ADMINS","1 2 3 4")

ADMINS = list(int(x) for x in (ADMINS).split())
...
UPSTREAM_REPO = environ.get('UPSTREAM_REPO', 'https://GitHub.Com/Crazebotz/AwesomeFilterPro')
